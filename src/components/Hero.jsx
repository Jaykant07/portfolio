  ...
  return (
    <div className="border-b border-neutral-900 pb-4 lg:mb-35 ml-4 sm:ml-10 ">
      <div className="flex flex-wrap items-center">
        <div className="w-full lg:w-1/2 ">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <motion.a
              ...
              href={resumePdf}
              target="_blank"
              className="mt-2 mb-10 px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700"
            >
              View Resume
            </motion.a>
          </div>
        ...
        <div className="w-full lg:w-1/2 lg:p-8 flex items-center justify-center sm:justify-end">
          <motion.img
            initial={{ x: 100, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 1, delaly: 1.5 }}
            className="w-48 h-54 sm:w-56 sm:h-62 rounded-3xl mt-2 sm:mt-6 shadow-lg"
            src={profilePic}
